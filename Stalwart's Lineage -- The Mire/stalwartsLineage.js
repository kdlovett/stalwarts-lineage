...
function boatStop(e) {
    //On key relaese, stop the appropriate actions.
    switch(e.keyCode) {
        case 87:
            cannonMovement = 0;
            break;
...
function updateAnimFrame() {
    ...
    if (boatHealth > 0 && win != 1 && gameStart == 0){
        ...
        animFrame.context.strokeText("...alluding the MOORLORD'S grasp...",320,100);
        animFrame.context.strokeText("...in hopes to bring peace once again...",320,150);
